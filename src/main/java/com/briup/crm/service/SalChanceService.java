...
public interface SalChanceService {
	...
	public PageInfo<SalChance> findSalChanceLike
	(int curPage,int size,String custName,String custRegion);
	...
	public PageInfo<SalChance> findChnaceByUserNameAndRegion
	(int curPage,int size,String dueTo,String region);
